...
public abstract class AbstractBackupActivity extends CheckedListActivity implements
    ...
    private String TAG = MyLogger.LOG_TAG + "/AbstractBackupActivity";
    ...
    protected void showProgress(int defaltMax, String defaltModule) {
        ...
        MyLogger.logI(TAG, "no need to set max");
    ...
    protected boolean errChecked() {
        ...
        if (isSDCardMissing) {
            ...
            ret = true;
            MyLogger.logI(TAG, "errChecked(): SDCard is full");
            if (mHandler != null) {
        ...
        mButtonBackup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if (isAllChecked(false)) {
                    MyLogger.logE(TAG, "to Backup List is null or empty");
                    return;
                }

                String path = SDCardUtils.getStoragePath(AbstractBackupActivity.this);
                Log.d(TAG, "onClick: back up path = " + path + ", is working = " + (Utils.getWorkingInfo() >
    ...
    protected void setButtonsEnable(boolean enable) {
        MyLogger.logD(TAG, "setButtonsEnable - " + enable);
            ...
            public void handleMessage(final Message msg) {
                ...
                case MessageID.PRESS_BACK:
                    ...
                    case MessageID.TOAST_NO_ITEM:
                        if (AbstractBackupActivity.this != null) {
                            Toast.makeText(AbstractBackupActivity.this, R.string.no_item_selected,
    ...
    public void onConfigurationChanged(final Configuration newConfig) {
        ...
        MyLogger.logI(TAG, "onConfigurationChanged");
    }
    ...
    protected boolean hasSelectedItem() {
        ...
        if (selectCount > 0) {
            MyLogger.logI(TAG, "hasSelectedItem selectCount : " + selectCount);
            return true;
        } else {
            MyLogger.logI(TAG, "hasSelectedItem No item selected");
            mHandler.obtainMessage(MessageID.TOAST_NO_ITEM).sendToTarget();
            return false;
        }
    }
}

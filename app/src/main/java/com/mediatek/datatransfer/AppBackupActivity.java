...
public class AppBackupActivity extends AbstractBackupActivity {
    ...
    public void startBackup() {
        ...
        if (mBackupService != null) {
            ...
            if (appPath == null) {
                MyLogger.logD(CLASS_TAG, "SD card is removed.");
                stopService();
                return ;
            }
    ...
    public void updateTitle() {
        ...
        MyLogger.logD(CLASS_TAG, "updateTitle() title: " + sb.toString());
    ...
    protected void checkBackupState() {
        ...
        if (mBackupService != null) {
            ...
            case State.PAUSE:
                ...
                MyLogger.logD(CLASS_TAG, CLASS_TAG + "checkBackupState: Max = " + p.mMax
            ...
            AlertDialog dialog = new AlertDialog.Builder(this).setCancelable(false)
                    ...
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(final DialogInterface dialog, final int which) {
                            ...
                            stopService();
                            try {
                                String appPath = SDCardUtils
                                        .getAppsBackupPath(AppBackupActivity.this);
                                ...
                                NotifyManager.getInstance(AppBackupActivity.this)
                                        .clearNotification();
                            } catch (NullPointerException e) {
                                e.printStackTrace();
                            } finally {
//                                Utils.exitLockTaskModeIfNeeded(AppBackupActivity.this);
                                finish();
                            }
                        }
        ...
        public void onBackupEnd(final BackupResultType resultCode,
            ...
            if (mHandler != null) {
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        MyLogger.logD(CLASS_TAG, "onBackupEnd showBackupResult()");
